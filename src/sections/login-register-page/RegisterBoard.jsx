...
export default function RegisterBoard() {
    ...
    return (
        <section className="w-full h-fit bg-white shrink-0  pb-10 flex flex-col ">
            ...
            <form onSubmit={handleSubmit(onSubmit)} autoComplete='off' className='flex flex-col gap-5 w-full pb-10 border-[#E5E5E5] border-b-1 mb-5'>
                ...
                <label htmlFor="usernameInput" className='flex flex-col gap-1 text-[11px] text-[#333333] '>Username
                    <input type="text" id='usernameInput' {...register('username')} className='h-12 bg-[#F2F2F2] w-full px-5 rounded-[5px] focus:border-2 outline-none border-[#007AFF] text-[15px] mb-5' placeholder='Username' />

                </label>


                <label htmlFor="passwordInput" className='flex flex-col gap-1 text-[11px] text-[#333333] '>Password
                    <div className='h-12 w-full flex relative mb-5'>
                    ...
                    <div className='h-12 w-full flex relative'>
                        <input type={showPwd ? 'text' : 'password'} id='passwordInput' {...register('confirmPwd')} className='h-12 bg-[#F2F2F2] w-full px-5 rounded-[5px] focus:border-2 outline-none border-[#007AFF] text-[15px]' placeholder='Confirm your password' />
                    </div>
