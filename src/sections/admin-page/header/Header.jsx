export default function Header({ handleChangeLayout }) {
    return (<header className="w-full h-14 bg-[#2C2C2C] border-[#444444] text-white border-b-1 flex justify-between items-center px-10" >
        <button className="h-full flex items-center cursor-pointer border-l-1 border-r-1 border-[#444444] px-5" onClick={() => handleChangeLayout("portfolio")}>
